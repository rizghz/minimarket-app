  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content enigma-dark-bg-1 shadow-lg">
      <div class="modal-header" style="border-color: #3B4252">
        <h5 class="modal-title" id="modal-label">Tambah Data Produk</h5>
        <button type="button" 
      ...
      <div class="modal-body my-3">
        @include('master.produk.components.form-tambah')
      </div>
    </div>
  </div>
</div>
...
<div id="form-modal-update" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-label" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content enigma-dark-bg-1 shadow-lg">
      <div class="modal-header" style="border-color: #3B4252">
        <h5 class="modal-title" id="modal-label">Edit Data Produk</h5>
        <button type="button" 
                class="btn m-0 px-2 py-1 z-depth-0 enigma-dark-bg-1 border-0 text-white" 
                data-dismiss="modal">
          <i class="ti-close"></i>
      ...
      <div class="modal-body my-3">
        @include('master.produk.components.form-update')
      </div>
    </div>
  </div>
</div>
